...
const bool World::storeEntity(const std::shared_ptr<objects::GameObject>& gameEntity)
{
	std::pair<helpers::Point, std::shared_ptr<objects::GameObject>> entityToStore;
...
objects::GameObject* World::findEntityAtPoint(const helpers::Point& point) const
{
